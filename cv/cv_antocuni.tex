...
\cventry{2010 -- now}{Researcher}{Heinrich-Heine-Universität}{Düsseldorf}{}{This
...
\cvitem{pdb++}{drop-in replacement and an extension of the standard
  ...
  using it.  Because of that, I recently released it as a standalone
  project.}
...
\cvitem{}{The following is a (partial and incomplete) list of FLOSS projects I
  ...
  features):}
\cvlistitem{py.test: \url{http://pytest.org/}}
\cvlistitem{pyrepl: \url{http://codespeak.net/pyrepl/}}
\cvlistitem{virtualenv: \url{http://pypi.python.org/pypi/virtualenv/}}
\cvlistitem{camelot: \url{http://www.python-camelot.com/}}
