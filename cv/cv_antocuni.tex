...
\cvitem{Technologies}{I am a primary a Python expert. Thanks to my work on
  PyPy I have a lot of experience in the field of language implementations:
  Virtual Machines, interpreters, AOT and JIT JIT compilers, etc.\newline
  I also have
  a strong experience with other technologies, including (but not limited to)
...
\cvitem{PyPy and FLOSS}{I have been a core contributor to various aspects of
  ...
  improving the Python scientific ecosystem, and I founded/launched the HPy
  project (see \emph{FLOSS Activity} for more details).  Other than PyPy and
  HPy, I started and have contributed to several FLOSS projects, as detailed
  below.}
...
\cventry{2020 -- now}{Developer}{HPy}{}{} {Thanks to a sponsorship, I have the
  possibility of working on HPy part-time. See below for a more in-depth
  description of HPy.}

\cventry{2020 -- now}{Developer}{Quansight}{}{} {My job at Quansight is to
...
\cventry{2012 -- 2020}{Consultant}{Gambit Research}{}{} {My primary task in
...
\cvitem{HPy}{The final goal of HPy is to improve the performance of the
  scientific stack on alternative implementations such as PyPy, and make it
  possible to experiment with deep CPython refactoring which are currently not
  possible because the C-API is too tied to the internals.  I am one of the
  founders of the project and the \emph{de facto} leading developer, as of
  2021.}
