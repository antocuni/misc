...
\cvitem{PyPy and FLOSS}{I have been a core contributor to various aspects of
  ...
  Python scientific ecosystem very fast on PyPY.  In the recent past, I leaded
  the migration of the PyPy repository from Subversion to Mercurial.  Other
  than PyPy, I started and have contributed to several FLOSS projects, as
  detailed below.}
